...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().cors()
                ...
                .and()
                .authorizeRequests().antMatchers("/robots.txt", "/sitemap.txt").permitAll()
                .and()
                ...
                .and()
                .authorizeRequests().antMatchers(HttpMethod.GET, "/sections", "/topics", "/comments", "/tags", "/search", "/users").permitAll()
                .and()
